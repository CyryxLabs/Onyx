"""Pinned current Onyx V20 HUD/QML integrity and explicit-exit acceptance."""
...
class CurrentHudAcceptanceV20Error(RuntimeError):
    """The current production HUD no longer matches its accepted closure."""


# Internal compatibility alias keeps the compact verifier implementation
# identical to the reviewed V19 predecessor while exposing a distinct V20 API.
CurrentHudAcceptanceV19Error = CurrentHudAcceptanceV20Error
...
MANIFEST_SHA256: Final = (
    "5acc031a3bff5350e3d985967bfcb49a1857ce3740be435f1213448f8e81f833"
)
...
CURRENT_RUNTIME_INPUTS: Final = (
    (
        Path("qml/OnyxLiveShellV7.qml"),
        "4f5b2774a556afc78a16cfca2b6c829f9d13e68d1ec395e2eff014e02f039b99",
    ),
    (
        Path("qml/OnyxLiveShellV8.qml"),
...
ARTIFACT_ROOT_SHA256: Final = (
    "cfb6cb1a9d6baa51c6145c5b188bf205e450216fe03eb2d2ebc5f01a768cdd44"
)
...
def verify_current_hud_acceptance(project: Path) -> dict[str, object]:
    ...
    if (
        manifest.get("schema") != "onyx.hud.current.v20.acceptance.v1"
        or manifest.get("candidate") != "onyx-hud-v9-exit-current-pinned-002"
