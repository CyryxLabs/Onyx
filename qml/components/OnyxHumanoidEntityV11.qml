...
Item {
    id: entity
    objectName: "onyxHumanoidPresenceV11Root"
    ...
    WebEngineView {
        id: threeView
        objectName: "onyxHumanoidThreeWebGLV2"
        anchors.fill: parent
        // Match the immutable HUD foundation so Chromium never exposes a
        // transparent, partially-cleared WebGL tile between presented frames.
        backgroundColor: "#050607"
        url: Qt.resolvedUrl("../web/onyx-humanoid-three-v2.html")
    ...
    Image {
        id: fallbackPlate
        objectName: "onyxHumanoidWebGLFallbackV2"
        anchors.fill: parent
        visible: entity.webglFailed
