...
Item {
    id: entity
    objectName: "onyxHumanoidPresenceV12Root"
    ...
    Image {
        ...
        anchors.fill: parent
        visible: entity.webglFailed || entity.continuitySlot === 0
    ...
    Image {
        ...
        anchors.fill: parent
        visible: !entity.webglFailed && entity.continuitySlot === 1
        sourceSize.width: 640
        sourceSize.height: 359
        fillMode: Image.PreserveAspectFit
        smooth: true
    ...
    WebEngineView {
        id: threeView
        objectName: "onyxHumanoidThreeWebGLV3"
        anchors.fill: parent
        backgroundColor: "transparent"
        url: Qt.resolvedUrl("../web/onyx-humanoid-three-v3.html")
