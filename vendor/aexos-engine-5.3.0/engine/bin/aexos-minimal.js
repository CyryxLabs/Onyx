...
console.log('\n⚠️  DEPRECATION WARNING: aexos-minimal is deprecated.');
console.log('   The --minimal mode (squads) was replaced by Squads.');
console.log('   Running standard installation wizard instead.\n');

// Get the path to the main router (aexos.js)
const routerPath = path.join(__dirname, 'aexos.js');
...
child.on('error', (error) => {
  console.error('❌ Failed to start AEXOS:', error.message);
  process.exit(1);
});
