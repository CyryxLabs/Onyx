 ...
 * IDE Configuration Metadata
 *
 * AEXOS (Cyryx) supports 6 main IDEs:
...
const IDE_CONFIGS = {
  'claude-code': {
    ...
    format: 'text',
    recommended: true,
    agentFolder: path.join('.claude', 'commands', 'AEXOS', 'agents'),
  ...
  gemini: {
    ...
    requiresDirectory: true,
    format: 'text',
    agentFolder: path.join('.gemini', 'rules', 'AEXOS', 'agents'),
  },
  cursor: {
    name: 'Cursor',
    description: '',
    configFile: path.join('.cursor', 'rules', 'aexos-global.mdc'),
