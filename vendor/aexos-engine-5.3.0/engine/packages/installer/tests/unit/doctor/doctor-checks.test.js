 ...
 * Story INS-4.1: aexos doctor rewrite
...
const nodeVersionCheck = require('../../../../../.aexos-core/core/doctor/checks/node-version');
const npmPackagesCheck = require('../../../../../.aexos-core/core/doctor/checks/npm-packages');
const settingsJsonCheck = require('../../../../../.aexos-core/core/doctor/checks/settings-json');
const rulesFilesCheck = require('../../../../../.aexos-core/core/doctor/checks/rules-files');
const agentMemoryCheck = require('../../../../../.aexos-core/core/doctor/checks/agent-memory');
const entityRegistryCheck = require('../../../../../.aexos-core/core/doctor/checks/entity-registry');
const gitHooksCheck = require('../../../../../.aexos-core/core/doctor/checks/git-hooks');
const coreConfigCheck = require('../../../../../.aexos-core/core/doctor/checks/core-config');
const claudeMdCheck = require('../../../../../.aexos-core/core/doctor/checks/claude-md');
const graphDashboardCheck = require('../../../../../.aexos-core/core/doctor/checks/graph-dashboard');
const codeIntelCheck = require('../../../../../.aexos-core/core/doctor/checks/code-intel');
const ideSyncCheck = require('../../../../../.aexos-core/core/doctor/checks/ide-sync');
const skillsCountCheck = require('../../../../../.aexos-core/core/doctor/checks/skills-count');
const commandsCountCheck = require('../../../../../.aexos-core/core/doctor/checks/commands-count');
const hooksClaudeCountCheck = require('../../../../../.aexos-core/core/doctor/checks/hooks-claude-count');
const { loadChecks } = require('../../../../../.aexos-core/core/doctor/checks');
...
describe('settings-json check', () => {
  it('should PASS with valid settings and sufficient deny rules', async () => {
    ...
    const mockSettings = {
      permissions: {
        deny: new Array(50).fill('Edit(.aexos-core/core/)'),
        allow: ['Edit(docs/)'],
      },
    };
...
describe('code-intel check', () => {
  ...
  it('should PASS with RegistryProvider when entity-registry exists', async () => {
    ...
    const registryPath = path.join(realProjectRoot, '.aexos-core', 'data', 'entity-registry.yaml');
...
describe('health-check.yaml task (INS-4.8)', () => {
  it('should NOT have *doctor alias', () => {
    ...
    const yaml = realFs.readFileSync(
      path.join(__dirname, '..', '..', '..', '..', '..', '.aexos-core', 'development', 'tasks', 'health-check.yaml'),
      'utf8',
    );
  ...
  it('should reference aexos doctor --json in instructions', () => {
    const realFs = jest.requireActual('fs');
    const yaml = realFs.readFileSync(
      path.join(__dirname, '..', '..', '..', '..', '..', '.aexos-core', 'development', 'tasks', 'health-check.yaml'),
      'utf8',
