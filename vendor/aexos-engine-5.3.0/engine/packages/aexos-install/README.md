...
- **Brownfield support**: Detects existing AEXOS installations and offers migration
...
If you have an existing AEXOS installation, the installer will:
...
- Documentation: https://github.com/CyryxLabs/AEXOS
