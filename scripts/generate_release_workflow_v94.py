"""Generate installed-live-lifecycle Release V94 over immutable V93."""
...
PREDECESSOR = ROOT / "tests/fixtures/release_workflow_transition_v93.json"
TARGET = ROOT / "tests/fixtures/release_workflow_transition_v94.json"
PREDECESSOR_SHA256 = "6f8883f724c574e4f1a47266bd905a7a35383db17b81b6cfe22b53ae3e0fe813"
...
def generate() -> dict[str, object]:
    if sha256(PREDECESSOR) != PREDECESSOR_SHA256:
        raise RuntimeError("Release V93 predecessor digest drifted")
    ...
    record = {
        "schema": "onyx.release-workflow-transition.v94",
        "issued_at": "2026-09-04T21:42:30-04:00",
        "logical_sequence": 94,
        "predecessor": {
    ...
    digest = hashlib.sha256(b"ONYX-RELEASE-WORKFLOW-TRANSITION-V94\0")
    for value in (
        record["issued_at"],
