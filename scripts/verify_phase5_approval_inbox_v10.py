...
SOURCE_REL = "docs/onyx/VE-SOURCE-P52-APPROVAL-INBOX-V10-001.sha256"
ARTIFACTS_REL = "docs/onyx/VE-ARTIFACTS-P52-APPROVAL-INBOX-V10-001.sha256"
BUNDLE_REL = "docs/onyx/checkpoints/phase5-approval-inbox-v10/phase5-approval-inbox-v10.bundle.json"
WORKER_REL = "scripts/verify_phase5_approval_inbox_v10_worker.py"
...
def main() -> int:
    ...
    if bundle.get("contract") != "Phase52ApprovalInboxEvidence.v10":
