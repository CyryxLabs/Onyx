"""Verify external E6 acceptance of Onyx Live Activation V10 C003."""
...
ID = "VE-ONYX-LIVE-ACTIVATION-V10-C003-E6-001"
...
SOURCE = ROOT / "docs/onyx/VE-SOURCE-ONYX-LIVE-ACTIVATION-V10-C003-E6-001.sha256"
ARTIFACTS = ROOT / "docs/onyx/VE-ARTIFACTS-ONYX-LIVE-ACTIVATION-V10-C003-E6-001.sha256"
ACCEPTANCE = (
    ROOT / "docs/onyx/VE-ACCEPTANCE-ONYX-LIVE-ACTIVATION-V10-C003-E6-001.sha256"
)
...
def verify() -> dict[str, object]:
    ...
    assert candidate["candidate"] == "onyx-live-activation-v10-c003"
    ...
    assert metadata["scope"] == "windows-c003-default-off-no-live-or-shortcut-write"
    ...
    expected_artifacts = {
        ...
        "docs/onyx/VE-SOURCE-ONYX-LIVE-ACTIVATION-V10-C003-E6-001.sha256",
        "docs/onyx/VE-ACCEPTANCE-ONYX-LIVE-ACTIVATION-V10-C003-E6-001.sha256",
        "scripts/verify_onyx_live_activation_v10_c003_acceptance.py",
        "tests/test_onyx_live_activation_v10_c003_acceptance.py",
    }
    ...
    external_temp = Path(
        tempfile.mkdtemp(prefix=".pytest-onyx-live-v10-c003-e6-", dir=ROOT)
    )
    try:
    ...
    assert "ONYX_LIVE_ACTIVATION_V10_C003_CANDIDATE_OK" in candidate_gate
    assert "ONYX_LIVE_ACTIVATION_V10_C003_MANIFEST_OK" in manifest_gate
    assert "ONYX_LIVE_ACTIVATION_V10_C003_PHYSICAL_SMOKE_OK" in smoke_gate
...
if __name__ == "__main__":
    print(
        "ONYX_LIVE_ACTIVATION_V10_C003_ACCEPTANCE_OK",
