"""Untracked-aware whitespace gate for Phase 5.3 Capability Nexus V16."""
...
SCOPE = (
    ...
    "scripts/check_phase5_capability_nexus_v16_whitespace.py",
    "scripts/phase5_capability_nexus_v16_subtest_reporter.py",
    "scripts/verify_phase5_capability_nexus_v16.py",
    "scripts/verify_phase5_capability_nexus_v16_worker.py",
    "tests/test_capability_nexus_v16.py",
)
...
def main() -> int:
    verify()
    print(f"P53_CAPABILITY_NEXUS_V16_WHITESPACE_OK files={len(SCOPE)}")
    return 0
