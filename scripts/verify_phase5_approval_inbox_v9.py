...
SOURCE_REL = "docs/onyx/VE-SOURCE-P52-APPROVAL-INBOX-V9-001.sha256"
ARTIFACTS_REL = "docs/onyx/VE-ARTIFACTS-P52-APPROVAL-INBOX-V9-001.sha256"
BUNDLE_REL = "docs/onyx/checkpoints/phase5-approval-inbox-v9/phase5-approval-inbox-v9.bundle.json"
WORKER_REL = "scripts/verify_phase5_approval_inbox_v9_worker.py"
...
def main() -> int:
    ...
    if bundle.get("contract") != "Phase52ApprovalInboxEvidence.v9":
    ...
    if len(lines) != 1 or not lines[0].startswith("P52_APPROVAL_INBOX_V9_EVIDENCE_OK "):
        print(process.stdout, end="")
        fail("worker-marker")
    print(lines[0])
    return 0
