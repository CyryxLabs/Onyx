"""Untracked-aware whitespace gate for Phase 5.3 Capability Nexus V24."""
...
SCOPE = (
    ...
    "scripts/verify_phase5_capability_nexus_v24.py",
...
def main() -> int:
    verify()
    print(f"P53_CAPABILITY_NEXUS_V24_WHITESPACE_OK files={len(SCOPE)}")
    return 0
