"""Reproduce the Phase 8 Microsoft Graph Calendar V1 candidate."""
...
from core import phase8_microsoft_graph_calendar_v1 as candidate  # noqa: E402
from scripts import (  # noqa: E402
    verify_phase8_microsoft_graph_live_read_e2e_v1_acceptance as phase8_live,
)
...
SELECTION = (
    PROJECT / "docs/onyx/checkpoints/phase8-microsoft-graph-calendar-v1/"
    "cumulative-selection.json"
)
MARKER = "P8_MICROSOFT_GRAPH_CALENDAR_V1_OK"
ARTIFACT_PATHS = (
    "core/phase8_microsoft_graph_calendar_v1.py",
    "tests/test_phase8_microsoft_graph_calendar_v1.py",
    "scripts/verify_phase8_microsoft_graph_calendar_v1.py",
    "docs/onyx/adrs/ADR-0040-phase8-microsoft-graph-calendar-v1.md",
    "docs/onyx/research/PHASE8_MICROSOFT_GRAPH_CALENDAR_V1_SOURCES.md",
    "docs/onyx/checkpoints/phase8-microsoft-graph-calendar-v1/"
    "PHASE8_MICROSOFT_GRAPH_CALENDAR_V1_CHECKPOINT.md",
    "docs/onyx/checkpoints/phase8-microsoft-graph-calendar-v1/"
...
def verify(*, run_tests: bool = True) -> dict[str, object]:
    ...
    if (
        manifest.get("schema") != "onyx.phase8.microsoft-graph-calendar.v1"
        or manifest.get("candidate") != "phase8-microsoft-graph-calendar-v1"
    ...
    live_result = phase8_live.verify(run_tests=False)
    if (
        live_result.get("decision") != "accepted"
        or live_result.get("candidate_artifact_root_sha256")
        != "30bdd9e3bf1bde4effa1acb7147fcd714d763c6fcc017e6b23fe189fcfabef6b"
    ):
        raise VerificationError("accepted live read E2E entry drift")
    candidate._verify_entry(PROJECT)
    if (
        candidate.create_microsoft_graph_calendar_v1(
            gate=candidate.GraphCalendarFeatureGateV1(False),
    ...
    source = (
        PROJECT / "core/phase8_microsoft_graph_calendar_v1.py"
    ).read_text(encoding="utf-8")
    for required in (
        'FEATURE_FLAG: Final = "ONYX_PHASE8_MICROSOFT_GRAPH_CALENDAR_V1"',
        "attendee invitations are denied",
        "reconcile before retry",
        "event mutation grant already used",
        'parsed.path != "/v1.0/me/events"',
    ...
    if run_tests:
        temporary = (
            PROJECT
            / "runtime/test-tmp/phase8-microsoft-graph-calendar-v1-verify"
