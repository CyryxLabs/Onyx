"""Generate continuous-audio Release V84 over immutable V83."""
...
PREDECESSOR = ROOT / "tests/fixtures/release_workflow_transition_v83.json"
TARGET = ROOT / "tests/fixtures/release_workflow_transition_v84.json"
PREDECESSOR_SHA256 = "cc7f807130d73b0e4a90dfe357e553f9fa959e6fae1939fa64b22577aa30df5e"
...
def generate() -> dict[str, object]:
    if sha256(PREDECESSOR) != PREDECESSOR_SHA256:
        raise RuntimeError("Release V83 predecessor digest drifted")
    ...
    record = {
        "schema": "onyx.release-workflow-transition.v84",
        "issued_at": "2026-09-02T20:22:31-04:00",
        "logical_sequence": 84,
        "predecessor": {
    ...
    digest = hashlib.sha256(b"ONYX-RELEASE-WORKFLOW-TRANSITION-V84\0")
    for value in (
        record["issued_at"],
