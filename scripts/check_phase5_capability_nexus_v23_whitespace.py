"""Untracked-aware whitespace gate for Phase 5.3 Capability Nexus V23."""
...
SCOPE = (
    ...
    "scripts/verify_phase5_capability_nexus_v23.py",
...
def main() -> int:
    verify()
    print(f"P53_CAPABILITY_NEXUS_V23_WHITESPACE_OK files={len(SCOPE)}")
    return 0
