"""Reproduce the Phase 8 Microsoft Graph Tasks V1 candidate."""
...
from core import phase8_microsoft_graph_tasks_v1 as candidate  # noqa: E402
from scripts import (  # noqa: E402
    verify_phase8_microsoft_graph_mail_v1_acceptance as phase8_mail,
)

MANIFEST = (
    PROJECT / "docs/onyx/checkpoints/phase8-microsoft-graph-tasks-v1/manifest.json"
)
SELECTION = (
    PROJECT / "docs/onyx/checkpoints/phase8-microsoft-graph-tasks-v1/"
    "cumulative-selection.json"
)
MARKER = "P8_MICROSOFT_GRAPH_TASKS_V1_OK"
ARTIFACT_PATHS = (
    "core/phase8_microsoft_graph_tasks_v1.py",
    "tests/test_phase8_microsoft_graph_tasks_v1.py",
    "scripts/verify_phase8_microsoft_graph_tasks_v1.py",
    "docs/onyx/adrs/ADR-0042-phase8-microsoft-graph-tasks-v1.md",
    "docs/onyx/research/PHASE8_MICROSOFT_GRAPH_TASKS_V1_SOURCES.md",
    "docs/onyx/checkpoints/phase8-microsoft-graph-tasks-v1/"
    "PHASE8_MICROSOFT_GRAPH_TASKS_V1_CHECKPOINT.md",
    "docs/onyx/checkpoints/phase8-microsoft-graph-tasks-v1/"
...
def verify(*, run_tests: bool = True) -> dict[str, object]:
    ...
    if (
        manifest.get("schema") != "onyx.phase8.microsoft-graph-tasks.v1"
        or manifest.get("candidate") != "phase8-microsoft-graph-tasks-v1"
    ...
    mail_result = phase8_mail.verify(run_tests=False)
    if (
        mail_result.get("decision") != "accepted"
        or mail_result.get("candidate_artifact_root_sha256")
        != "73875e708fbd9684cddec51fb34cb327b958c7e851f5035f37cbce9540cf30f0"
    ):
        raise VerificationError("accepted Mail V1 entry drift")
    candidate._verify_entry(PROJECT)
    if (
        candidate.create_microsoft_graph_tasks_v1(
            gate=candidate.GraphTasksFeatureGateV1(False),
    ...
    source = (PROJECT / "core/phase8_microsoft_graph_tasks_v1.py").read_text(
        encoding="utf-8"
    )
    for required in (
        ...
        "task create grant already used",
        "self._nonce_ledger.consume(grant.nonce)",
        "tasks write scope was not granted",
    ...
    if run_tests:
        temporary = (
            PROJECT
            / "runtime/test-tmp/phase8-microsoft-graph-tasks-v1-verify"
