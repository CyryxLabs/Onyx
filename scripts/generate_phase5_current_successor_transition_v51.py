"""Generate Phase 5 current-successor V51 over immutable V50."""
...
PREDECESSOR = ROOT / "tests/fixtures/phase5_current_successor_transition_v50.json"
TARGET = ROOT / "tests/fixtures/phase5_current_successor_transition_v51.json"
PREDECESSOR_SHA256 = "5dfd1616743c6c41bf9a37d8d7a17f02928e284f1153d4e883a95460491f252f"
ISSUED_AT = "2026-08-11T13:05:00-04:00"
DOMAIN = b"ONYX-PHASE5-CURRENT-SUCCESSOR-TRANSITION-V51\0"
...
def generate() -> dict[str, object]:
    if sha256(PREDECESSOR) != PREDECESSOR_SHA256:
        raise RuntimeError("Phase 5 V50 predecessor digest drifted")
    predecessor = json.loads(PREDECESSOR.read_text(encoding="utf-8"))
    if predecessor.get("schema") != "onyx.phase5-current-successor-transition.v50":
        raise RuntimeError("Phase 5 V50 predecessor contract drifted")
    historical = []
