"""Untracked-aware whitespace gate for Phase 5.3 Capability Nexus V14."""
...
SCOPE = (
    ...
    "scripts/verify_phase5_capability_nexus_v14.py",
...
def main() -> int:
    verify()
    print(f"P53_CAPABILITY_NEXUS_V14_WHITESPACE_OK files={len(SCOPE)}")
    return 0
