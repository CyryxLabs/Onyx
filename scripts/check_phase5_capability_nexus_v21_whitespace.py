"""Untracked-aware whitespace gate for Phase 5.3 Capability Nexus V21."""
...
SCOPE = (
    ...
    "scripts/check_phase5_capability_nexus_v21_whitespace.py",
    "scripts/phase5_capability_nexus_v21_subtest_reporter.py",
    "scripts/verify_phase5_capability_nexus_v21.py",
    "scripts/verify_phase5_capability_nexus_v21_worker.py",
    "tests/test_capability_nexus_v21.py",
)
...
def main() -> int:
    verify()
    print(f"P53_CAPABILITY_NEXUS_V21_WHITESPACE_OK files={len(SCOPE)}")
    return 0
