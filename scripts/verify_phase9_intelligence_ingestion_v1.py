"""Reproduce the Phase 9 Intelligence Ingestion V1 candidate."""
...
from core import phase9_intelligence_ingestion_v1 as candidate  # noqa: E402
from scripts import (  # noqa: E402
    verify_phase8_exit_candidate_v1_acceptance as phase8_exit,
)

BASE = PROJECT / "docs/onyx/checkpoints/phase9-intelligence-ingestion-v1"
MANIFEST = BASE / "manifest.json"
SELECTION = BASE / "cumulative-selection.json"
MARKER = "P9_INTELLIGENCE_INGESTION_V1_OK"
ARTIFACT_PATHS = (
    "core/phase9_intelligence_ingestion_v1.py",
    "tests/test_phase9_intelligence_ingestion_v1.py",
    "scripts/verify_phase9_intelligence_ingestion_v1.py",
    "docs/onyx/adrs/ADR-0045-phase9-intelligence-ingestion-v1.md",
    "docs/onyx/research/PHASE9_INTELLIGENCE_INGESTION_V1_SOURCES.md",
    "docs/onyx/checkpoints/phase9-intelligence-ingestion-v1/"
    "PHASE9_INTELLIGENCE_INGESTION_V1_CHECKPOINT.md",
    "docs/onyx/checkpoints/phase9-intelligence-ingestion-v1/"
...
def verify(*, run_tests: bool = True) -> dict[str, object]:
    ...
    if (
        manifest.get("schema") != "onyx.phase9.intelligence-ingestion.v1"
        or manifest.get("candidate") != "phase9-intelligence-ingestion-v1"
    ...
    exit_result = phase8_exit.verify(run_tests=False)
    if (
        exit_result.get("decision") != "accepted"
        or exit_result.get("candidate_artifact_root_sha256")
        != "114cba2de27b680848ed5bfe6ddba7e0033c6448d6f85d198689aa8cffc1485a"
    ):
        raise VerificationError("accepted Phase 8 exit entry drift")
    candidate._verify_entry(PROJECT)
    if (
        candidate.create_intelligence_ingestion_v1(
            gate=candidate.IntelligenceIngestionFeatureGateV1(False),
    ...
    source = (PROJECT / "core/phase9_intelligence_ingestion_v1.py").read_text(
        encoding="utf-8"
    )
    for required in (
    ...
    if run_tests:
        temporary = (
            PROJECT
            / "runtime/test-tmp/phase9-intelligence-ingestion-v1-verify"
