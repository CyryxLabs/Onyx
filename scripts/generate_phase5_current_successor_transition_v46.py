"""Generate Phase 5 current-successor V46 over immutable V45."""
...
PREDECESSOR = ROOT / "tests/fixtures/phase5_current_successor_transition_v45.json"
TARGET = ROOT / "tests/fixtures/phase5_current_successor_transition_v46.json"
PREDECESSOR_SHA256 = "8fa01953bfd6a4dbda2623b9e20f71d06268dfa66907ac6b1019210459ad582a"
ISSUED_AT = "2026-08-10T19:45:00-04:00"
...
DOMAIN = b"ONYX-PHASE5-CURRENT-SUCCESSOR-TRANSITION-V46\0"
...
def generate() -> dict[str, object]:
    if sha256(PREDECESSOR) != PREDECESSOR_SHA256:
        raise RuntimeError("Phase 5 V45 predecessor digest drifted")
    predecessor = json.loads(PREDECESSOR.read_text(encoding="utf-8"))
    if predecessor.get("schema") != "onyx.phase5-current-successor-transition.v45":
        raise RuntimeError("Phase 5 V45 predecessor contract drifted")
    ...
    record: dict[str, object] = {
        "schema": "onyx.phase5-current-successor-transition.v46",
        "issued_at": ISSUED_AT,
