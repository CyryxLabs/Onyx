"""Reproduce the Phase 8 Microsoft Graph Live Read E2E V1 candidate."""
...
from core import phase8_microsoft_graph_live_read_e2e_v1 as candidate  # noqa: E402
...
MANIFEST = (
    PROJECT
    / "docs/onyx/checkpoints/phase8-microsoft-graph-live-read-e2e-v1/manifest.json"
)
SELECTION = (
    PROJECT / "docs/onyx/checkpoints/phase8-microsoft-graph-live-read-e2e-v1/"
    "cumulative-selection.json"
)
MARKER = "P8_MICROSOFT_GRAPH_LIVE_READ_E2E_V1_OK"
ARTIFACT_PATHS = (
    "core/phase8_microsoft_graph_live_read_e2e_v1.py",
    "tests/test_phase8_microsoft_graph_live_read_e2e_v1.py",
    "scripts/run_phase8_microsoft_graph_live_read_e2e_v1.py",
    "scripts/verify_phase8_microsoft_graph_live_read_e2e_v1.py",
    "docs/onyx/adrs/ADR-0038-phase8-microsoft-graph-live-read-e2e-v1.md",
    "docs/onyx/research/PHASE8_MICROSOFT_GRAPH_LIVE_READ_E2E_V1_SOURCES.md",
    "docs/onyx/PHASE8_MICROSOFT_GRAPH_LIVE_ONBOARDING.md",
    "docs/onyx/checkpoints/phase8-microsoft-graph-live-read-e2e-v1/"
    "PHASE8_MICROSOFT_GRAPH_LIVE_READ_E2E_V1_CHECKPOINT.md",
    "docs/onyx/checkpoints/phase8-microsoft-graph-live-read-e2e-v1/"
...
def verify(*, run_tests: bool = True) -> dict[str, object]:
    ...
    if (
        manifest.get("schema") != "onyx.phase8.microsoft-graph-live-read-e2e.v1"
        or manifest.get("candidate") != "phase8-microsoft-graph-live-read-e2e-v1"
    ...
    if (
        candidate.create_microsoft_graph_live_read_e2e_v1(
            gate=candidate.GraphLiveE2EFeatureGateV1(False),
    ...
    source = (
        PROJECT / "core/phase8_microsoft_graph_live_read_e2e_v1.py"
    ...
    if run_tests:
        temporary = (
            PROJECT
            / "runtime/test-tmp/phase8-microsoft-graph-live-read-e2e-v1-verify"
