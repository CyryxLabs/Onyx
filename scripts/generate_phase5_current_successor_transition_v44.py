"""Generate Phase 5 current-successor V44 over immutable V43."""
...
PREDECESSOR = ROOT / "tests/fixtures/phase5_current_successor_transition_v43.json"
TARGET = ROOT / "tests/fixtures/phase5_current_successor_transition_v44.json"
PREDECESSOR_SHA256 = (
    "90decf307197888f9f4ee2ab54c5dd8105fbacaafcf0792048db6cecff264b27"
)
ISSUED_AT = "2026-08-10T15:55:00-04:00"
PREDECESSOR_CLOCK_ANOMALY = {
    "predecessor_issued_at": "2026-08-10T18:30:00-04:00",
    "observed_at": ISSUED_AT,
    "reason": "predecessor_future_dated",
}
DOMAIN = b"ONYX-PHASE5-CURRENT-SUCCESSOR-TRANSITION-V44\0"
...
def generate() -> dict[str, object]:
    if sha256(PREDECESSOR) != PREDECESSOR_SHA256:
        raise RuntimeError("Phase 5 V43 predecessor digest drifted")
    predecessor = json.loads(PREDECESSOR.read_text(encoding="utf-8"))
    if predecessor.get("schema") != "onyx.phase5-current-successor-transition.v43":
        raise RuntimeError("Phase 5 V43 predecessor contract drifted")
    ...
    record: dict[str, object] = {
        "schema": "onyx.phase5-current-successor-transition.v44",
        "issued_at": ISSUED_AT,
