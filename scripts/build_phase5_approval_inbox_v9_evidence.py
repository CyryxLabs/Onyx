...
CHECKPOINT = ROOT / "docs/onyx/checkpoints/phase5-approval-inbox-v9"
...
def main() -> int:
    ...
    focused_junit = CHECKPOINT / "phase5-approval-inbox-v9.junit.xml"
    combined_junit = CHECKPOINT / "phase5-approval-inbox-v9.combined.junit.xml"
    regressions_junit = CHECKPOINT / "phase5-approval-inbox-v9.regressions.junit.xml"
    ...
    write(CHECKPOINT / "phase5-approval-inbox-v9.raw.log", focused_output)
    write(CHECKPOINT / "phase5-approval-inbox-v9.combined.log", combined_output)
    write(CHECKPOINT / "phase5-approval-inbox-v9.regressions.log", regression_output)
    ...
    write(
        CHECKPOINT / "phase5-approval-inbox-v9.static.log",
        "\n\n".join(static_lines) + "\n",
    )
    ...
    write(
        CHECKPOINT / "phase5-approval-inbox-v9.live-scan.sha256",
    ...
    checkpoint_text = f"""# Phase 5.2 Approval Inbox V9 checkpoint
...
- Combined Approval Inbox V1-V9: {combined["passed"]} passed in {combined_seconds:.3f}s.
...
- Live reachability scan: {len(live_entries)} files, no V9 flag/module reference.
...
"""
    checkpoint_md = CHECKPOINT / "PHASE5_2_APPROVAL_INBOX_V9_CHECKPOINT.md"
    ...
    v9_files = [
        ...
        "docs/onyx/checkpoints/phase5-approval-inbox-v9/phase5-approval-inbox-v9.raw.log",
        "docs/onyx/checkpoints/phase5-approval-inbox-v9/phase5-approval-inbox-v9.combined.log",
        "docs/onyx/checkpoints/phase5-approval-inbox-v9/phase5-approval-inbox-v9.regressions.log",
        "docs/onyx/checkpoints/phase5-approval-inbox-v9/phase5-approval-inbox-v9.static.log",
        "docs/onyx/checkpoints/phase5-approval-inbox-v9/phase5-approval-inbox-v9.live-scan.sha256",
        "docs/onyx/checkpoints/phase5-approval-inbox-v9/mutable-projections.json",
        *(entry["snapshot"] for entry in projections),
    ]
    files = sorted(set(historical + v9_files))
    ...
    bundle = {
        ...
        "claims": {
            ...
            "no_live_wiring": True,
            "historical_v1_v8_preserved": True,
    ...
    bundle_path = CHECKPOINT / "phase5-approval-inbox-v9.bundle.json"
