"""Generate the acyclic Release V37 transition over immutable V36."""
...
PREDECESSOR = ROOT / "tests/fixtures/release_workflow_transition_v36.json"
TARGET = ROOT / "tests/fixtures/release_workflow_transition_v37.json"
ISSUED_AT = "2026-08-10T15:30:00-04:00"
LOGICAL_SEQUENCE = 37
CURRENT_PATHS = (
...
def generate() -> dict[str, object]:
    ...
    if [entry["path"] for entry in entries] != sorted(
        ...
        raise RuntimeError("Release V37 paths must remain sorted")
    predecessor = json.loads(PREDECESSOR.read_text(encoding="utf-8"))
    record: dict[str, object] = {
        "schema": "onyx.release-workflow-transition.v37",
        "issued_at": ISSUED_AT,
    ...
    digest.update(b"ONYX-RELEASE-WORKFLOW-TRANSITION-V37\0")
