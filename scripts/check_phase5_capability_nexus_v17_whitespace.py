"""Untracked-aware whitespace gate for Phase 5.3 Capability Nexus V17."""
...
SCOPE = (
    ...
    "scripts/check_phase5_capability_nexus_v17_whitespace.py",
    "scripts/phase5_capability_nexus_v17_subtest_reporter.py",
    "scripts/verify_phase5_capability_nexus_v17.py",
    "scripts/verify_phase5_capability_nexus_v17_worker.py",
    "tests/test_capability_nexus_v17.py",
)
...
def main() -> int:
    verify()
    print(f"P53_CAPABILITY_NEXUS_V17_WHITESPACE_OK files={len(SCOPE)}")
    return 0
