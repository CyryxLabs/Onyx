"""Capture deterministic offscreen evidence for the temporally stable humanoid HUD."""
...
import core.onyx_hud_orb_v15 as hud_v15  # noqa: E402
import ui  # noqa: E402
...
OUTPUT_DIR = ROOT / "docs/onyx/evidence/hud-humanoid-v11-stable"


def main() -> int:
    app = QApplication.instance() or QApplication(["onyx-humanoid-v11-stable-capture"])
    ...
    if not hud_v15.install_current(ui):
        raise RuntimeError("failed to install humanoid HUD V15")
    ...
    for _ in range(5):
        app.processEvents()
    hud_v15.uninstall_candidate(ui)
