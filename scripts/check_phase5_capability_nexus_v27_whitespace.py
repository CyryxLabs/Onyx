"""Untracked-aware whitespace gate for Phase 5.3 Capability Nexus V27."""
...
SCOPE = (
    ...
    "scripts/verify_phase5_capability_nexus_v27.py",
    "scripts/verify_phase5_capability_nexus_v27_worker.py",
    "tests/test_capability_nexus_v27.py",
)
...
def main() -> int:
    verify()
    print(f"P53_CAPABILITY_NEXUS_V27_WHITESPACE_OK files={len(SCOPE)}")
    return 0
