"""Desktop bootstrap establishing the exact canonical V14 environment."""
...
LAUNCHER = ROOT / "scripts/launch_onyx_live_v14.pyw"
...
def run() -> None:
    if sys.argv[1:] not in ([], ["--preflight-only"]):
        raise RuntimeError("Onyx Live V14 bootstrap arguments are invalid")
