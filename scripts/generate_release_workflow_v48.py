"""Generate the acyclic Release V48 transition over immutable V47."""
...
PREDECESSOR = ROOT / "tests/fixtures/release_workflow_transition_v47.json"
TARGET = ROOT / "tests/fixtures/release_workflow_transition_v48.json"
PREDECESSOR_SHA256 = (
    "96743238fee217e561ceb91734649aa1394f930acc312a30e0491bd7714267cc"
)
ISSUED_AT = "2026-08-11T03:37:00-04:00"
LOGICAL_SEQUENCE = 48
CURRENT_PATHS = (
    ...
    "tests/test_current_release_documentation_v48.py",
    ...
    "tests/test_owner_name_command_v1.py",
    ...
    "tests/test_phase6_network_text_provider_v1.py",
...
def generate() -> dict[str, object]:
    if sha256(PREDECESSOR) != PREDECESSOR_SHA256:
        raise RuntimeError("Release V47 predecessor digest drifted")
    entries = [
    ...
    if [entry["path"] for entry in entries] != sorted(
        ...
        raise RuntimeError("Release V48 paths must remain sorted")
    predecessor = json.loads(PREDECESSOR.read_text(encoding="utf-8"))
    if predecessor.get("schema") != "onyx.release-workflow-transition.v47":
        raise RuntimeError("Release V47 predecessor contract drifted")
    record: dict[str, object] = {
        "schema": "onyx.release-workflow-transition.v48",
        "issued_at": ISSUED_AT,
    ...
    digest.update(b"ONYX-RELEASE-WORKFLOW-TRANSITION-V48\0")
