"""Regenerate the deterministic packaged HUD and V28 source manifests."""
...
from core.onyx_hud_current_acceptance_v28 import CURRENT_RUNTIME_PATHS  # noqa: E402
...
V28 = ROOT / "docs/onyx/acceptance/VE-HUD-CURRENT-V28-E6-001.manifest.json"
...
def main() -> None:
    ...
    v28 = {
        "schema": "onyx.hud.current.v28.acceptance.v1",
        "candidate": "onyx-hud-v10-post-v41-posix-preflight-selection-010",
        "decision": "accepted-source",
        "current_root": "qml/OnyxLiveShellV10.qml",
        "predecessor": {
            "manifest_path": "docs/onyx/acceptance/VE-HUD-CURRENT-V27-E6-001.manifest.json",
            "manifest_sha256": "2b8bc8f9f58a8b6e426065304826baccdd72325f389c7bb685d77d389b51d3d9",
            "acceptance_path": "core/onyx_hud_current_acceptance_v27.py",
            "acceptance_sha256": "991dc6bf17d3f9f6f0058b0d00dce2ff430044ac7d85953ddd651fb5325b0afd",
        },
