"""Generate Phase 5 current-successor V42 over immutable V41."""
...
PREDECESSOR = ROOT / "tests/fixtures/phase5_current_successor_transition_v41.json"
TARGET = ROOT / "tests/fixtures/phase5_current_successor_transition_v42.json"
PREDECESSOR_SHA256 = (
    "7b23628ec33513dc37357718fc6783fcc400f3d014307377d196570ddb4fc8cb"
)
ISSUED_AT = "2026-08-10T14:30:00-04:00"
DOMAIN = b"ONYX-PHASE5-CURRENT-SUCCESSOR-TRANSITION-V42\0"
...
def generate() -> dict[str, object]:
    if sha256(PREDECESSOR) != PREDECESSOR_SHA256:
        raise RuntimeError("Phase 5 V41 predecessor digest drifted")
    predecessor = json.loads(PREDECESSOR.read_text(encoding="utf-8"))
    if predecessor.get("schema") != "onyx.phase5-current-successor-transition.v41":
        raise RuntimeError("Phase 5 V41 predecessor contract drifted")
    ...
    record: dict[str, object] = {
        "schema": "onyx.phase5-current-successor-transition.v42",
        "issued_at": ISSUED_AT,
        "predecessor": {
