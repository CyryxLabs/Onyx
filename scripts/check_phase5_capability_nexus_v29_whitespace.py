"""Untracked-aware whitespace gate for Phase 5.3 Capability Nexus V29."""
...
SCOPE = (
    ...
    "scripts/verify_phase5_capability_nexus_v29.py",
    "scripts/verify_phase5_capability_nexus_v29_worker.py",
    "tests/test_capability_nexus_v29.py",
)
...
def main() -> int:
    verify()
    print(f"P53_CAPABILITY_NEXUS_V29_WHITESPACE_OK files={len(SCOPE)}")
    return 0
