# Phase 5.3 Capability Nexus V28 checkpoint
...
V28 always constructs a fresh parent wrapper when cleanup records or overflow
...
artifact and root manifests. V27 collector budgets, hostile rendering, DAG,
...
Every phase owns its complete process tree. V28 has no bootstrap file, process,
...
Quantitative evidence is exclusively recorded in `docs/onyx/checkpoints/phase5-capability-nexus-v28/phase5-capability-nexus-v28.metrics.json`.
No quantitative result in this checkpoint is accepted outside that structured artifact.

V28 remains isolated, default-off, shadow-only, not live and externally unaccepted.
